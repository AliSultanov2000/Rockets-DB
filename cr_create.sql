...
DROP TABLE IF EXISTS Lpe_tests;

CREATE TABLE Lpe_tests
(id_engine_t INT,
...
DROP TABLE IF EXISTS Lde_tests;

CREATE TABLE Lde_tests
(id_engine_t INT,
t1_engine_test DATETIME NOT NULL,
t2_engine_test DATETIME NOT NULL,
engine_test_name VARCHAR(255) NOT NULL,
...
DROP TABLE IF EXISTS Sfe_tests;

CREATE TABLE Sfe_tests
(id_engine_t INT,
t1_engine_test DATETIME NOT NULL,
t2_engine_test DATETIME NOT NULL,
engine_test_name VARCHAR(255) NOT NULL,
