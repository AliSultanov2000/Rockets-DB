...
(5, 6, 4, 'RD-111', 'Liquid propellant rocket engine', 'Pump', 'L + G', 'Lobed', 1, 1, 'Laval nozzle', TRUE, 'Regenerative', 'Smooth', 150, 149, 160, 160.5, 0.2, 0.2, 1.2, 'Сhemical', TRUE, TRUE),
...
DELETE FROM Lpe_tests;

INSERT Lpe_tests(id_engine_t, t1_engine_test, t2_engine_test, engine_test_name, engine_test_result, thrust_test, specific_impulse_test, P_combustion_chamber_test)
VALUES
...
DELETE FROM Lde_tests;

INSERT Lde_tests(id_engine_t, t1_engine_test, t2_engine_test, engine_test_name, engine_test_result, thrust_test, specific_impulse_test, P_combustion_chamber_test)
VALUES
...
DELETE FROM Sfe_tests;

INSERT Sfe_tests(id_engine_t, t1_engine_test, t2_engine_test, engine_test_name, engine_test_result, thrust_test, specific_impulse_test, P_combustion_chamber_test)
VALUES
...
INSERT Dimension_1stages(id_dimension, d, l_head, l_instrument_compartment, l_fuel_tank, l_inter_tank, l_oxidizer_tank, l_tail_section)
VALUES
(1, 0.4, 1, 0.5, 1.5, 0.3, 1, 0.9),  
(2, 0.5, 1, 0.5, 1.5, 0.3, 1, 1), 
(3, 0.5, 1, 0.5, 2, 0.3, 1.5, 1), 
(4, 0.5, 0.8, 0.3, 1.1, 0.1, 0.8, 0.6), 
(5, 1, 1.5, 0.4, 2.5, 0, 2, 1),  
(6, 0.8, 1.3, 0.3, 2.2, 0, 1.7, 0.6),  
(7, 0.9, 1.4, 0.3, 2.6, 0.3, 2.1, 1), 
(8, 0.6, 0.9, 0.3, 1.9, 0, 1.2, 0.7); 



DELETE FROM Dimension_2stages;

INSERT Dimension_2stages(id_dimension, d_1stage, d_2stage, l_head, l_instrument_compartment, l_1stage_fuel_tank, l_1stage_inter_tank,
...
VALUES
(1,  3, 3, 3.7, 1, 6, 0.8, 4, 2.6, 1.8, 3.3, 0.8, 2.1),  
(2,  3, 3, 3.7, 0.7, 6.2, 0, 3.8, 2.5, 1.7, 3.3, 0, 2), 
(3,   3, 3, 4,  0.7,  5.8, 0, 3.6, 2.5, 1.3, 3, 0, 2),  
(4,  3, 2.5, 4, 0.6,  5.6, 0, 3.5, 2.4, 1.2, 3, 0, 2), 
(5,  3, 2.5, 4, 0.6,  5.6, 0, 3.5, 2.4, 1.2, 3, 0, 2), 
(6,  3,  3,  4, 0.7,  5.8, 0, 3.6, 2.4, 1.2, 3, 0, 1.8),   
(7,  2.5, 2.5, 3.5, 0.5, 5, 0, 3, 2, 1, 3.4, 0, 2.2),
(8,  2.5, 2.5, 3.5, 0.5, 5, 0, 3, 2, 1, 3.4, 0, 2.2), 
(9,  2, 2, 3, 0.5, 4, 0, 2.5, 1.6, 1, 2.5, 0, 1.3), 
(10, 1.7, 1.7, 2.8, 0.2, 1, 0, 0.8, 0.8, 0.35, 1, 0, 0.8), 
(11, 1.5, 1.5, 2.5, 0.2, 1, 0, 0.6, 0.8, 0.35, 1, 0, 0.6) 


DELETE FROM Mass_1stages;

INSERT Mass_1stages(id_m1, m_head, m_instrument_compartment, m_fuel_tank, m_inter_tank, m_oxidizer_tank, m_tail_section, m_fuel, m_oxidizer)
VALUES
(1,  70, 53, 50, 4, 43, 145, 500, 300), 
(2,  74, 58, 78, 4,  63, 202, 611, 312), 
(3,  80, 83, 102, 5, 89, 201, 843, 620), 
(4,  90, 82, 88, 4, 62, 186,  742, 591), 
(5,  116, 106, 164, 0, 138, 184, 2100, 1200),    
(6,  121, 85, 120, 0, 111, 195, 1450, 814),
(7,  107, 120, 185, 4, 160, 220, 2200, 1530),
(8,  95, 88, 94, 0, 75, 178, 850, 650)



DELETE FROM Mass_2stages; 

INSERT Mass_2stages(id_m2,  m_head, m__instrument_compartment, m_1stage_fuel_tank, m_1stage_inter_tank, m_1stage_oxidizer_tank,
...
VALUES
(1,  120, 90, 150, 4, 120, 520, 75, 100, 4, 89, 410,  70000, 30000,  25000, 10000), 
(2,  150, 100, 157, 0, 133, 520, 70, 101, 0, 87, 395, 85000, 45000, 32000, 18000),  
(3,  170, 150, 159, 0, 135, 521, 72, 96, 0, 88, 394, 87000, 47500, 33400, 18650), 
(4,  190, 124, 146, 0, 120, 452, 70, 94, 0, 78, 304, 15000, 5800, 8000, 3900), 
(5,  130, 124, 146, 0, 120, 452, 70, 94, 0, 69, 304, 15000, 5800, 8000, 3900), 
(6,  180, 170, 195, 0, 110, 612, 90, 140, 0, 97, 415, 90000, 50000, 34000, 19500), 
(7,  100, 90, 110, 0, 79, 410, 70, 90, 0, 54, 312, 20000, 8000, 7000, 2800), 
(8,  100, 90, 110, 0, 79, 410, 70, 90, 0, 54, 312, 20000, 8000, 7000, 2800), 
(9,  89, 84, 94, 0, 75, 380, 70, 74, 0, 59, 315,  15000, 6000, 6400, 2100), 
(10, 67, 39, 62, 0, 42, 196, 12,  51, 0, 39, 110, 800, 300, 620, 286), 
(11, 90, 79, 83, 0, 61, 299, 20, 67, 0, 49, 214, 2500, 1500, 1000, 625);
...
mission_success, mission_customer, basing,  t_launch_preparation, t_start_time, launch_cost, rocket_efficiency, id_1dim, id_2dim, id_1mass, id_2mass,
id_1elem, id_2elem, id_test, id_param)
VALUES                                                                                                                         
(1, 1, 1, 'TP-16', 'OKB-586', '18А400', 340, 90, 5, TRUE, 'UA', 'Starting table',  300, '1962-04-10', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(2, 1, 1, 'TP-16', 'OKB-586', '18А401', 344, 92, 10, TRUE, 'UA', 'Starting table',  300, '1962-05-12', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(3, 1, 1, 'TP-16', 'OKB-586', '18А402', 190, 15, 3, TRUE, 'UA', 'Starting table',  300, '1962-06-18', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(4, 1, 1, 'TP-16', 'OKB-586', '18А403', 215, 20, 2, TRUE, 'UA', 'Starting table',  300, '1963-07-20', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(5, 1, 1, 'TP-16', 'OKB-586', '18А404', 550, 25, 5, TRUE, 'UA', 'Starting table',  300, '1963-03-21', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(6, 1, 1, 'TP-16', 'OKB-586', '18А405', 490, 24, 5, TRUE, 'UA', 'Starting table',  300, '1963-07-27', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(7, 1, 1, 'TP-16', 'OKB-586', '18А406', 380, 70, 4, TRUE, 'USA', 'Starting table',  300, '1963-08-21', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(8, 1, 1, 'TP-16', 'OKB-586', '18А407', 340, 75,  3, TRUE, 'USA', 'Starting table',  300, '1963-07-19', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(9, 1, 1, 'TP-16', 'OKB-586', '18А408', 340, 75.3, 2, TRUE, 'UK', 'Starting table',  300, '1963-03-11', 12300000, 0.89, NULL, 1, NULL, 1, 8, 8, 1, 1),
(10, 1, 1, 'TP-36', 'OKB-586', '18А409', 348, 79, 4, TRUE,  'UK', 'Starting table',   250, '1967-07-15', 13450000, 0.92, NULL, 2, NULL, 2, 8, 8, 2, 2),
(11, 1, 1, 'TP-36', 'OKB-586', '18А410', 290, 70.3, 6, TRUE, 'UK', 'Starting table',   250, '1967-04-18', 3450000, 0.92, NULL, 2, NULL, 2, 8, 8, 2, 2),
(12, 1, 1, 'TP-36', 'OKB-586', '18А411', 190,  20, 4, TRUE, 'UK', 'Starting table',   250, '1967-02-22', 13450000, 0.92, NULL, 2, NULL, 2, 8, 8, 2, 2),
(13, 1, 1, 'TP-36', 'OKB-586', '18А412', 330,  21, 2, TRUE, 'UK', 'Starting table',   250, '1967-01-11', 13450000, 0.92, NULL, 2, NULL, 2, 8, 8, 2, 2),
(14, 1, 1, 'TP-36', 'OKB-586', '18А413', 550,  22, 1, TRUE, 'UK', 'Starting table',   250, '1967-09-10', 13450000, 0.92, NULL, 2, NULL, 2, 8, 8, 2, 2),
(15, 1, 1, 'TP-36', 'OKB-586', '18А414', 600,  22, 10, TRUE, 'AZE', 'Starting table',   250, '1967-10-12', 13450000, 0.92, NULL, 2, NULL, 2, 8, 8, 2, 2),
(16, 1, 1, 'TP-36', 'OKB-586', '18А415', 640,  22.3, 5, TRUE, 'AZE', 'Starting table',   250, '1967-11-18', 13450000, 0.92, NULL, 2, NULL, 2, 8, 8, 2, 2),
(17, 2, 2, 'TР-36-M', 'OKB-586', '18А416', 430,  23.1, 3, TRUE, 'ARM', 'Starting table',   120, '1990-09-13',  11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(18, 2, 2, 'TP-36-M', 'OKB-586', '18А417', 424,  30, 2, TRUE, 'ARM', 'Starting table',   120, '1990-08-14', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(19, 2, 2, 'TP-36-М', 'OKB-586', '18А418', 522,  31.2, 1, TRUE, 'ARM', 'Starting table',   120, '1990-12-15', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(20, 2, 2, 'TP-36-M', 'OKB-586', '18А419', 645,  32.6, 5, TRUE, 'ARM', 'Starting table',   120, '1990-02-22', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(21, 2, 2, 'TP-36-M', 'ОКB-586', '18А420', 423,  39, 5, TRUE, 'ARM', 'Starting table',   120, '1990-03-28', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(22, 2, 2, 'TP-36-M', 'ОКB-586', '18А421', 312,  40, 5, TRUE, 'JS', 'Starting table',   120, '1990-11-27', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(23, 2, 2, 'TP-36-M', 'ОКB-586', '18А422', 524,  31, 5, TRUE, 'JS', 'Starting table',   120, '1991-06-13', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(24, 2, 2, 'TP-36-M', 'ОКB-586', '18А423', 423,  31.2, 5, TRUE, 'AZE', 'Starting table',   120, '1991-07-19', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(25, 2, 2, 'TP-36-M', 'ОКB-586', '18А424', 323,  39, 5, TRUE, 'TK', 'Starting table',   120, '1992-02-24', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(26, 2, 2, 'TP-36-M', 'ОКB-586', '18А425', 440,  41, 6, TRUE, 'TK', 'Starting table',   120, '1992-12-13', 11200000, 0.96, NULL, 3, NULL, 3, 8, 8, 3, 3),
(27, 1, 1, 'AIDO-1725', 'ОКB-52', '18А426', 510,  43, 6, TRUE, 'TK', 'Starting table',  180, '1975-04-14', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(28, 1, 1, 'AIDO-1725', 'ОКB-52', '18А427', 340,  44, 6, TRUE, 'TK', 'Starting table',  180, '1975-03-17', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(29, 1, 1, 'AIDO-1725', 'ОКB-52', '18А428', 390,  45, 6, TRUE, 'TK', 'Starting table', 180, '1975-02-13', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(30, 1, 1, 'AIDO-1725', 'ОКB-52', '18А429', 400,  46.2, 6, TRUE, 'USA', 'Starting table',  180, '1975-01-12', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(31, 1, 1, 'AIDO-1725', 'ОКB-52', '18А430', 320,  48, 3, TRUE, 'USA', 'Starting table',  180, '1975-02-18', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(32, 1, 1, 'AIDO-1725', 'ОКB-52', '18А431', 350,  50, 2, TRUE, 'USA', 'Starting table',  180, '1975-09-22', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(33, 1, 1, 'AIDO-1725', 'ОКB-52', '18А432', 380,  80, 1, TRUE, 'UA', 'Starting table',  180, '1976-10-12', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(34, 1, 1, 'AIDO-1725', 'ОКB-52', '18А433', 396,  82, 4, TRUE, 'UA', 'Starting table',  180, '1976-12-16', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(35, 1, 1, 'AIDO-1725', 'ОКB-52', '18А434', 399,  84, 5, TRUE, 'USA', 'Starting table',  180, '1976-05-18', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(36, 1, 1, 'AIDO-1725', 'ОКB-52', '18А435', 410,  85, 5, TRUE, 'UA', 'Starting table',  180, '1976-12-25', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(37, 1, 1, 'AIDO-1725', 'ОКB-52', '18А436', 420,  84, 7, TRUE, 'UA', 'Starting table',  180, '1976-09-12', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(38, 1, 1, 'AIDO-1725', 'ОКB-52', '18А437', 430,  86, 6, TRUE, 'UA', 'Starting table',  180, '1976-11-03', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(39, 1, 1, 'AIDO-1725', 'ОКB-52', '18А438', 640,  31, 5, TRUE, 'UA', 'Starting table',  180, '1976-12-01', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(40, 1, 1, 'AIDO-1725', 'ОКB-52', '18А439', 321,  32, 4, TRUE, 'TK', 'Starting table',  180, '1976-10-09', 7560000, 0.94, NULL, 4, NULL, 4, 8, 8, 4, 4),
(41, 1, 1, 'AIDO-1725-M', 'ОКB-52', '18А440', 420, 90, 3, TRUE, 'TK', 'Starting table',  120, '1995-06-12', 7800000, 0.95, NULL, 5, NULL, 5, 8, 8, 5, 5),
(42, 1, 1, 'AIDO-1725-M', 'ОКB-52', '18А441', 323, 91, 2, TRUE, 'TK', 'Starting table',  120, '1995-04-16', 7800000, 0.95, NULL, 5, NULL, 5, 8, 8, 5, 5),
(43, 1, 1, 'AIDO-1725-M', 'ОКB-52', '18А442', 320, 93, 7, TRUE, 'USA', 'Starting table',  120, '1995-12-18', 7800000, 0.95, NULL, 5, NULL, 5, 8, 8, 5, 5),
(44, 1, 1, 'AIDO-1725-M', 'ОКB-52', '18А443', 0, 0, 0, FALSE, 'USA', 'Starting table',  120, '1995-04-01', 7800000, 0.95, NULL, 5, NULL, 5, 8, 8, 5, 5),
(45, 1, 1, 'AIDO-1725-M', 'ОКB-52', '18А444', 0,  0, 0, FALSE,  'USA', 'Starting table',  120, '1995-10-02', 7800000, 0.95, NULL, 5, NULL, 5, 8, 8, 5, 5),
(46, 1, 1, 'AIDO-1725-M', 'ОКB-52', '18А445', 320,  94, 7, TRUE, 'TK', 'Starting table',  120, '1995-09-08', 7800000, 0.95, NULL, 5, NULL, 5, 8, 8, 5, 5),
(47, 1, 1, 'AIDO-1725-M', 'ОКB-52', '18А446', 280,  31, 4, TRUE, 'TK', 'Starting table',  120, '1995-02-05', 7800000, 0.95, NULL, 5, NULL, 5, 8, 8, 5, 5),
(48, 2, 3, 'CRT-400', 'Space Y', '18А447', 211,  38, 7, TRUE, 'USA', 'Starting table',  70, '2020-04-12', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(49, 2, 3, 'CRT-400', 'Space Y', '18А448', 260,  30, 5, TRUE, 'USA', 'Starting table',  70, '2020-03-08', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(50, 2, 3, 'CRT-400', 'Space Y', '18А449', 290,  31, 5, TRUE, 'AZE', 'Starting table',  70, '2020-02-13', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(51, 2, 3, 'CRT-400', 'Space Y', '18А450', 280,  38, 5, TRUE, 'UK', 'Starting table',  70, '2020-10-19', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(52, 2, 3, 'CRT-400', 'Space Y', '18А451', 300,  36, 5, TRUE, 'UK', 'Starting table',  70, '2021-09-26', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(53, 2, 3, 'CRT-400', 'Space Y', '18А452', 217,  35, 5, TRUE, 'PK', 'Starting table',  70, '2021-07-25', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(54, 2, 3, 'CRT-400', 'Space Y', '18А453', 250,  34, 5, TRUE, 'PK', 'Starting table',  70, '2022-02-19', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(55, 2, 3, 'CRT-400', 'Space Y', '18А454', 230,  31, 5, TRUE, 'USA', 'Starting table',  70, '2022-11-12', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(56, 2, 3, 'CRT-400', 'Space Y', '18А455', 220,  33, 5, TRUE, 'UA', 'Starting table',  70, '2022-12-15', 8350000, 0.96, NULL, 6, NULL, 6, 8, 8, 6, 6),
(57, 7, NULL, 'ISNO-550', 'KBM', '18А456', 230,  32, 6, TRUE, 'UA', 'Starting table',  90, '2008-04-15', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(58, 7, NULL, 'ISNO-550', 'KBM', '18А457', 243,  34, 6, TRUE, 'US', 'Starting table',  90, '2008-01-17', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(59, 7, NULL, 'ISNO-550', 'КBM', '18А458', 222,  39, 6, TRUE, 'ES', 'Starting table', 90, '2008-08-27', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(60, 7, NULL, 'ISNO-550', 'КBM', '18А459', 216,  34, 4, TRUE, 'ES', 'Starting table',  90, '2008-02-20', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(61, 7, NULL, 'ISNO-550', 'КBM', '18А460', 330,  24, 4, TRUE, 'ES', 'Starting table',  90, '2009-07-19', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(62, 7, NULL, 'ISNO-550', 'КBM', '18А461', 221,  31.1, 4, TRUE, 'PK', 'Starting table', 90, '2009-09-15', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(63, 7, NULL, 'ISNO-550', 'КBM', '18А462', 199,  33, 3, TRUE, 'PK', 'Starting table',  90, '2010-08-12', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(64, 7, NULL, 'ISNO-550', 'КBM', '18А463', 270,  39, 3, TRUE, 'PK', 'Starting table',  90, '2010-09-17', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(65, 7, NULL, 'ISNO-550', 'КBM', '18А464', 214,  40, 3, TRUE, 'PK', 'Starting table',  90, '2010-02-16', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(66, 7, NULL, 'ISNO-550', 'КBM', '18А465', 216,  47, 3, TRUE, 'UA', 'Starting table',  90, '2010-03-11', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(67, 7, NULL, 'ISNO-550', 'КBM', '18А466', 219,  49, 3, TRUE, 'UA', 'Starting table',  90, '2011-10-03', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(68, 7, NULL, 'ISNO-550', 'КBM', '18А467', 210,  50, 3, TRUE, 'UA', 'Starting table',  90, '2011-12-19', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(69, 7, NULL, 'ISNO-550', 'КBM', '18А468', 222,  90, 2, TRUE, 'UA', 'Starting table',  90, '2011-11-13', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(70, 7, NULL, 'ISNO-550', 'КBM', '18А469', 217,  190, 3, TRUE, 'UA', 'Starting table',  90, '2011-05-10', 3950000, 0.92, 5, NULL, 5, NULL, 4, NULL, 7, 7),
(71, 12, NULL, 'XE-6', 'MKB Rainbow', '18А470', 160,  91, 5, TRUE, 'AZE', 'Aviation basing',  150, '1983-12-13', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(72, 12, NULL, 'XE-6', 'MKB Rainbow', '18А471', 130, 107, 4, TRUE, 'AZE', 'Aviation basing',  150, '1983-05-01', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(73, 12, NULL, 'XE-6', 'MKB Rainbow', '18А472', 140,  103, 10, TRUE, 'USA', 'Aviation basing',  150, '1983-03-02', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(74, 12, NULL, 'XE-6', 'MKB Rainbow', '18А473', 160,  109, 11, TRUE, 'ES', 'Aviation basing',  150, '1983-10-05', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(75, 12, NULL, 'XE-6', 'MKB Rainbow', '18А474', 130,  132, 12, TRUE, 'PK', 'Aviation basing',  150, '1983-11-11', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(76, 12, NULL, 'XE-6', 'MKB Rainbow', '18А475', 122,  93, 10, TRUE, 'PK', 'Aviation basing', 150, '1983-07-09', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(77, 12, NULL, 'XE-6', 'MKB Rainbow', '18А476', 143,  94, 5, TRUE, 'PK', 'Aviation basing',  150, '1983-08-04', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(78, 12, NULL, 'XE-6', 'MKB Rainbow', '18А477', 122,  91, 5, TRUE, 'UA', 'Aviation basing',  150, '1983-04-10', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(79, 12, NULL, 'XE-6', 'MKB Rainbow', '18А478', 130,  93, 5, TRUE, 'UA', 'Aviation basing',  150, '1983-03-21', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(80, 12, NULL, 'XE-6', 'MKB Rainbow', '18А479',  121,  95, 5, TRUE, 'ESA', 'Aviation basing',  150, '1983-02-23', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(81, 12, NULL, 'XE-6', 'MKB Rainbow', '18А480', 132,  94, 5, TRUE, 'UA', 'Aviation basing',  150, '1983-01-23', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(82, 12, NULL, 'XE-6', 'MKB Rainbow', '18А481', 122,  90, 4, TRUE, 'UA', 'Aviation basing',  150, '1983-10-27', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(83, 12, NULL, 'XE-6', 'MKB Rainbow', '18А482', 190,  91, 4, TRUE, 'UA', 'Aviation basing',  150, '1983-11-20', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(84, 12, NULL, 'XE-6', 'MKB Rainbow', '18А483', 130,  92, 2, TRUE, 'USA', 'Aviation basing',  150, '1983-12-17', 1200000, 0.8, 1, NULL, 1, NULL, 4, NULL, 8, 8),
(85, 11, NULL, 'XE-9', 'MKB Rainbow', '18А484', 150,  93, 2, TRUE, 'EA', 'Aviation basing',  140, '1990-11-22', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(86, 11, NULL, 'XE-9', 'MKB Rainbow', '18А485', 155,  94, 1, TRUE, 'UA', 'Aviation basing',  140, '1990-09-27', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(87, 11, NULL, 'XE-9', 'MKB Rainbow', '18А486', 156,  95, 5, TRUE, 'UA', 'Aviation basing',  140, '1990-04-24', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(88, 11, NULL, 'XE-9', 'MKB Rainbow', '18А487', 140,  96, 5, TRUE, 'UA', 'Aviation basing',  140, '1990-02-13', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(89, 11, NULL, 'XE-9', 'MKB Rainbow', '18А488', 120,  97, 5, TRUE, 'UA', 'Aviation basing',  140, '1991-06-05', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(90, 11, NULL, 'XE-9', 'MKB Rainbow', '18А489', 121,  98, 4, TRUE, 'UA', 'Aviation basing',  140, '1991-09-14', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(91, 11, NULL, 'XE-9', 'MKB Rainbow', '18А490', 122,  99, 7, TRUE, 'ARM', 'Aviation basing',  140, '1991-11-15', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(92, 11, NULL, 'XE-9', 'MKB Rainbow', '18А491', 123,  100, 7, TRUE, 'ARM', 'Aviation basing',  140, '1992-07-17', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(93, 11, NULL, 'XE-9', 'MKB Rainbow', '18А492', 145,  101, 7, TRUE, 'GA', 'Aviation basing',  140, '1992-02-11', 1340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(94, 11, NULL, 'XE-9', 'MKB Rainbow', '18А493', 190,  40, 7, TRUE, 'GA', 'Aviation basing',  140, '1992-01-19', 340000, 0.85, 2, NULL, 2, NULL, 4, NULL, 9, 9),
(95, 11, NULL, 'XE-14', 'MKB Rainbow', '18А494', 200,  41, 7, TRUE, 'GA', 'Aviation basing',  110, '2005-12-31', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(96, 11, NULL, 'XE-14', 'MKB Rainbow', '18А495', 180,  42, 7, TRUE, 'GA', 'Aviation basing',  110, '2005-04-12', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(97, 11, NULL, 'XE-14', 'MKB Rainbow', '18А496', 183,  43, 7, TRUE, 'GA', 'Aviation basing',  110, '2005-03-18', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(98, 11, NULL, 'XE-14', 'MKB Rainbow', '18А497', 189,  44, 7, TRUE, 'GA', 'Aviation basing',  110, '2005-09-12', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(99, 11, NULL, 'XE-14', 'MKB Rainbow', '18А498', 135,  45, 7, TRUE, 'UA', 'Aviation basing',  110, '2005-08-16', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(100, 11, NULL, 'XE-14', 'MKB Rainbow', '18А499', 122,  46, 5, TRUE, 'UA', 'Aviation basing',  110, '2006-01-19', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(101, 11, NULL, 'XE-14', 'MKB Rainbow', '18А500', 132,  47, 5, TRUE, 'UA', 'Aviation basing',  110, '2006-02-27', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(102, 11, NULL, 'XE-14', 'MKB Rainbow', '18А501', 190,  48, 5, TRUE, 'USA', 'Aviation basing',  110, '2006-04-15', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(103, 11, NULL, 'XE-14', 'MKB Rainbow', '18А502', 132, 49, 5, TRUE, 'UA', 'Aviation basing',  110, '2006-06-19', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(104, 11, NULL, 'XE-14', 'MKB Rainbow', '18А503', 124,  50, 7, TRUE, 'UA', 'Aviation basing',  110, '2006-09-20', 1100000, 0.88, 3, NULL, 3, NULL, 11, NULL, 10, 10),
(105, 24, 24, 'PR-88', 'ОКB-34', '18А504', 250,  51, 5, TRUE, 'UK', 'Starting table',  130, '1998-04-15', 13500000, 0.94, NULL, 7, NULL, 7, 17, 17, 11, 11),
(106, 24, 24, 'PR-88', 'ОКB-34', '18А505', 290,  52, 5, TRUE, 'UK', 'Starting table',  130, '1998-05-19', 13500000, 0.94, NULL, 7, NULL, 7, 17, 17, 11, 11),
(107, 24, 24, 'PR-88', 'ОКB-34', '18А506', 280,  53, 5, TRUE, 'USA', 'Starting table',  130, '1998-08-20', 13500000, 0.94, NULL, 7, NULL, 7, 17, 17, 11, 11),
(108, 24, 24, 'PR-88', 'ОКB-34', '18А507', 320,  54, 5, TRUE, 'AZE', 'Starting table',  130, '1998-02-27', 13500000, 0.94, NULL, 7, NULL, 7, 17, 17, 11, 11),
(109, 24, 24, 'PR-88', 'ОКB-34', '18А508', 210,  55, 3, TRUE, 'PK', 'Starting table',  130, '1998-01-29', 13500000, 0.94, NULL, 7, NULL, 7, 17, 17, 11, 11),
(110, 24, 24, 'PR-88', 'ОКB-34', '18А509', 300,  56, 4, TRUE, 'PK', 'Starting table',  130, '1998-11-12', 13500000, 0.94, NULL, 7, NULL, 7, 17, 17, 11, 11),
(111, 24, 24, 'PR-88', 'ОКB-34', '18А510', 315,  57, 7, TRUE, 'PK', 'Starting table',  130, '1999-10-16', 13500000, 0.94, NULL, 7, NULL, 7, 17, 17, 11, 11),
(112, 24, 24, 'PR-88-M', 'ОКB-34', '18А511', 320,  58, 8, TRUE, 'PK', 'Starting table',  110, '2005-10-20', 12400000, 0.95, NULL, 8, NULL, 8, 17, 17, 12, 12),
(113, 24, 24, 'PR-88-M', 'ОКB-34', '18А512', 322,  59, 8, TRUE, 'UA', 'Starting table',  110, '2005-11-26', 12400000, 0.95, NULL, 8, NULL, 8, 17, 17, 12, 12),
(114, 24, 24, 'PR-88-M', 'ОКB-34', '18А513', 340,  60, 8, TRUE, 'UA', 'Starting table',  110, '2005-05-13', 12400000, 0.95, NULL, 8, NULL, 8, 17, 17, 12, 12),
(115, 24, 24, 'PR-88-M', 'ОКB-34', '18А514', 350,  61, 7, TRUE, 'UA', 'Starting table',  110, '2006-03-20', 12400000, 0.95, NULL, 8, NULL, 8, 17, 17, 12, 12),
(116, 24, 24, 'PR-88-M', 'ОКB-34', '18А515', 330,  62, 6, TRUE, 'USA', 'Starting table',  110, '2006-02-17', 12400000, 0.95, NULL, 8, NULL, 8, 17, 17, 12, 12),
(117, 24, 24, 'PR-88-M', 'ОКB-34', '18А516', 350,  62, 8, TRUE, 'UA', 'Starting table',  110, '2006-08-04', 12400000, 0.95, NULL, 8, NULL, 8, 17, 17, 12, 12),
(118, 12, NULL, 'U-120', 'NPO', '18А517', 360,  62, 5, TRUE, 'AZE', 'Sea basing',   135, '1972-03-20', 1150000, 0.91, 6, NULL, 6, NULL, 5, NULL, 13, 13),
(119, 12, NULL, 'U-120', 'NPO', '18А518', 366,  62, 5, TRUE, 'ARM', 'Sea basing',   135, '1973-10-25', 1150000, 0.91, 6, NULL, 6, NULL, 5, NULL, 13, 13),
(120, 12, NULL, 'U-120', 'NPO', '18А519', 370,  130, 4, TRUE, 'ARM', 'Sea basing',   135, '1973-11-09', 1150000, 0.91, 6, NULL, 6, NULL, 5, NULL, 13, 13),
(121, 12, NULL, 'U-120', 'NPO', '18А520', 375,  131, 4, TRUE, 'ARM', 'Sea basing',   135, '1973-09-12', 1150000, 0.91, 6, NULL, 6, NULL, 5, NULL, 13, 13),
(122, 16, NULL, 'U-700', 'NPO', '18А521', 380,  132, 4, TRUE, 'ARM', 'Sea basing',  120, '1993-06-11', 1200000, 0.92, 7, NULL, 7, NULL, 5, NULL, 14, 14),
(123, 16, NULL, 'U-700', 'NPO', '18А522', 388,  133, 7, TRUE, 'UA', 'Sea basing',  120, '1993-07-12', 1200000, 0.92, 7, NULL, 7, NULL, 5, NULL, 14, 14),
(124, 16, NULL, 'U-700', 'NPO', '18А523', 390,  160, 7, TRUE, 'UA', 'Sea basing',  120, '1993-03-15', 1200000, 0.92, 7, NULL, 7, NULL, 5, NULL, 14, 14),
(125, 16, NULL, 'U-700', 'NPO', '18А524', 395,  91, 7, TRUE, 'OS', 'Sea basing',  120, '1993-02-20', 1200000, 0.92, 7, NULL, 7, NULL, 5, NULL, 14, 14),
(126, 16, NULL, 'U-700', 'NPO', '18А525', 396, 92, 6, TRUE, 'OS', 'Sea basing',  120, '1993-10-21', 1200000, 0.92, 7, NULL, 7, NULL, 5, NULL, 14, 14),
(127, 16, NULL, 'U-700', 'NPO', '18А526', 320,  90, 6, TRUE, 'OS', 'Sea basing',  120, '1993-12-30', 1200000, 0.92, 7, NULL, 7, NULL, 5, NULL, 14, 14),
(128, 16, 18, 'U-1000', 'NPO', '18А527', 300,  94, 4, TRUE, 'OS', 'Sea basing',  110, '2008-10-10', 1340000, 0.97, NULL, 11, NULL, 11, 5, 5, 15, 15),
(129, 16, 18, 'U-1000', 'NPO', '18А528', 305,  95, 5, TRUE, 'TL', 'Sea basing',  110, '2008-11-15', 1340000, 0.97, NULL, 11, NULL, 11, 5, 5, 15, 15),
(130, 16, 18, 'U-1000', 'NPO', '18А529', 310,  96, 6, TRUE, 'TL', 'Sea basing',  110, '2008-04-20', 1340000, 0.97, NULL, 11, NULL, 11, 5, 5, 15, 15),
(131, 16, 18, 'U-1000', 'NPO', '18А530', 315,  97, 6, TRUE, 'TL', 'Sea basing',  110, '2008-02-17', 1340000, 0.97, NULL, 11, NULL, 11, 5, 5, 15, 15),
(132, 16, 18, 'U-1000', 'NPO', '18А531', 320,  97, 7, TRUE, 'TL', 'Sea basing',  110, '2009-12-19', 1340000, 0.97, NULL, 11, NULL, 11, 5, 5, 15, 15),
(133, 16, 18, 'U-1000', 'NPO', '18А532', 325,  90, 3, TRUE, 'TL', 'Sea basing',  110, '2009-05-11', 1340000, 0.97, NULL, 11, NULL, 11, 5, 5, 15, 15),
(134, 16, 18, 'U-1000', 'NPO', '18А533', 330,  94, 8, TRUE, '', 'Sea basing',  110, '2009-07-14', 1340000, 0.97, NULL, 11, NULL, 11, 5, 5, 15, 15),
(135, 6, 6, 'CRK-7', 'NPO', '18А534', 340,  80, 5, TRUE, 'USA', 'Sea basing',  90, '2019-05-12', 1500000, 0.98, NULL, 10, NULL, 10, 5, 5, 16, 16), 
(136, 6, 6, 'CRK-7', 'NPO', '18А535', 350,  82, 8, TRUE, 'UA', 'Sea basing',  90, '2019-05-12', 1500000, 0.98, NULL, 10, NULL, 10, 5, 5, 16, 16), 
(137, 6, 6, 'CRK-7', 'NPO', '18А536', 360,  81, 7, TRUE, 'UK', 'Sea basing',  90, '2019-05-12', 1500000, 0.98, NULL, 10, NULL, 10, 5, 5, 16, 16), 
(138, 6, 6, 'CRK-7', 'NPO', '18А537', 370,  50, 6, TRUE, 'UK', 'Sea basing',  90, '2019-05-12', 1500000, 0.98, NULL, 10, NULL, 10, 5, 5, 16, 16),
(139, 6, 6, 'CRK-7', 'NPO', '18А538', 375,  60, 5, TRUE, 'UK', 'Sea basing',  90, '2019-05-12', 1500000, 0.98, NULL, 10, NULL, 10, 5, 5, 16, 16), 
(140, 6, 6, 'CRK-7', 'NPO', '18А539', 380,  90, 8, TRUE, 'UA', 'Sea basing',  90, '2019-05-12', 1500000, 0.98, NULL, 10, NULL, 10, 5, 5, 16, 16), 
(141, 27, NULL, 'KLF-486', 'OKB New technologies', '18А540', 270,  180, 6, TRUE, 'UK', 'Sea basing',  94, '2005-04-16', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(142, 27, NULL, 'KLF-486', 'OKB New technologies', '18А541', 275,  160, 6, TRUE, 'ARM', 'Sea basing',  94, '2005-09-14', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(143, 27, NULL, 'KLF-486', 'OKB New technologies', '18А542', 278,  150, 4, TRUE, 'AZE', 'Sea basing',  94, '2006-06-19', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(144, 27, NULL, 'KLF-486', 'OKB New technologies', '18А543', 281,  140, 4, TRUE, 'TL', 'Sea basing',  94, '2006-09-08', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(145, 27, NULL, 'KLF-486', 'OKB New technologies', '18А544', 284,  135, 8, TRUE, 'UK', 'Sea basing',  94, '2006-10-09', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(146, 27, NULL, 'KLF-486', 'OKB New technologies', '18А545', 285,  130, 7, TRUE, 'USA', 'Sea basing',  94, '2006-11-13', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(147, 27, NULL, 'KLF-486', 'OKB New technologies', '18А546', 288,  125, 6, TRUE, 'USA', 'Sea basing',  94, '2006-12-25', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(148, 27, NULL, 'KLF-486', 'OKB New technologies', '18А547', 300,  120, 8, TRUE, 'USA', 'Sea basing',  94, '2006-02-20', 1200000, 0.94, 4, NULL, 4, NULL, 18, NULL, 17, 17),
(149, 27, NULL, 'BST-321', 'NPO', '18А548', 200,  100, 5, TRUE, 'UK', 'Starting table',  110, '2010-04-05', 1250000, 0.94, 8, NULL, 8, NULL, 18, NULL, 18, 18),
(150, 27, NULL, 'BST-321', 'NPO', '18А549', 205,  101, 5, TRUE, 'UK', 'Starting table',  110, '2011-04-21', 1250000, 0.94, 8, NULL, 8, NULL, 18, NULL, 18, 18),
(151, 27, NULL, 'BST-321', 'NPO', '18А550', 210,  102, 4, TRUE, 'UK', 'Starting table',  110, '2010-06-19', 1250000, 0.94, 8, NULL, 8, NULL, 18, NULL, 18, 18),
(152, 27, NULL, 'BST-321', 'NPO', '18А551', 200,  103, 4, TRUE, 'UK', 'Starting table',  110, '2010-08-14', 1250000, 0.94, 8, NULL, 8, NULL, 18, NULL, 18, 18),
(153, 27, NULL, 'BST-321', 'NPO', '18А552', 200,  104, 3, TRUE, 'USA', 'Starting table',  110, '2011-10-15', 1250000, 0.94, 8, NULL, 8, NULL, 18, NULL, 18, 18),
(154, 27, NULL, 'BST-321', 'NPO', '18А553', 216,  105, 3, TRUE, 'UA', 'Starting table',  110, '2011-11-25', 1250000, 0.94, 8, NULL, 8, NULL, 18, NULL, 18, 18),
(155, 23, 23, 'PIO-780', 'ОКB-34', '18А554', 320,  106, 3, TRUE, 'UA', 'Starting table',  140, '1976-03-27', 12300000, 0.93, NULL, 9, NULL, 9, 17, 17, 19, 19),
(156, 23, 23, 'PIO-780', 'ОКB-34', '18А555', 325,  107, 3, TRUE, 'UK', 'Starting table',  140, '1976-08-23', 12300000, 0.93, NULL, 9, NULL, 9, 17, 17, 19, 19),
(157, 23, 23, 'PIO-780', 'ОКB-34', '18А556', 330,  108, 2, TRUE, 'UK', 'Starting table',  140, '1976-09-20', 12300000, 0.93, NULL, 9, NULL, 9, 17, 17, 19, 19),
(158, 23, 23, 'PIO-780', 'ОКB-34', '18А557', 332,  109, 2, TRUE, 'USA', 'Starting table',  140, '1976-12-26', 12300000, 0.93, NULL, 9, NULL, 9, 17, 17, 19, 19),
(159, 23, 23, 'PIO-780', 'ОКB-34', '18А558', 335,  110, 6, TRUE, 'TL', 'Starting table',  140, '1976-04-19', 12300000, 0.93, NULL, 9, NULL, 9, 17, 17, 19, 19),
(160, 23, 23, 'PIO-780', 'ОКB-34', '18А559', 340,  111, 7, TRUE, 'UA', 'Starting table',  140, '1976-02-10', 12300000, 0.93, NULL, 9, NULL, 9, 17, 17, 19, 19);
...
(68, 'HP with a blunted tip', 'Communication satellite', TRUE, 650000,TRUE,  40, 480),
